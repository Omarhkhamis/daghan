...
export default function DentalImplantSec({
  data,
  whatsappLink,
  locale = "en"
}) {
    ...
    <section className="relative overflow-hidden bg-gradient-to-r pt-10 md:pt0  from-gray-100 via-gray-200 to-gray-100">
      ...
      <div className="mx-auto max-w-screen-2xl px-6 lg:px-10">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div
            className={`relative z-10 lg:max-w-4xl space-y-6 py-8 lg:py-24 ${
              isRtl ? "lg:pl-24 text-right" : "lg:pr-24"
            }`}
          >
          ...
          <div className="relative lg:static">
            <div
              className={`relative h-[360px] sm:h-[420px] lg:absolute lg:inset-y-0 lg:w-1/2 lg:h-auto ${
            ...
            >
              ...
              <div
                className={`none pointer-events-none md:absolute inset-y-0 w-[55%] ${
                  isRtl
                    ? "right-0 bg-gradient-to-l from-gray-200 via-gray-200/60 to-transparent"
                    : "left-0 bg-gradient-to-r from-gray-200 via-gray-200/60 to-transparent"
                }`}
              ></div>

              <div
                className={`absolute -top-40 md:top-auto md:bottom-14 h-28 w-28 md:h-42 md:w-42 rounded-full bg-white/25 backdrop-blur-sm border border-white/35 flex items-center justify-center ${
                  isRtl
                    ? "left-0 md:left-[24vh]"
                    : "right-0 md:right-[24vh]"
                }`}
              >
                <img
